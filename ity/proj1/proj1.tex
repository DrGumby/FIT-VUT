...
\title{Typografie a publikování\\[3mm]
        \large 1. projekt}
\author{Kamil Vojanec\\
        xvojan00@fit.vutbr.cz}
\date{}
...
\begin{quotation}
Čím více \texttt{druhů,}
{\textbf {\textit{řezů,}}} {\small velikostí,} barev písma {\fontfamily{phv}\selectfont a~jiných efektů} použijeme, tím \textit{profesionálněji} bude dokument vypadat. Čtenář tím {\tiny bude} vždy {\huge \bfseries nadšen!}
\end{quotation}  
...
Tento dokument schválně obsahuje několik typografických prohřešků. Sekce \hyperref[sec:mistake1]{2} a \hyperref[sec:mistake2]{3} obsahují typografické chyby. V kontextu celého textu je jistě snadno najdete. Je dobré znát možnosti \LaTeX u, ale je také nutné vědět, kdy je nepoužít.
